      ...
      fields: [
        {
          ...
          admin: { width: '25%', description: 'Mørkeblå prikker.' },
        },
        {
          name: 'showTenders',
          type: 'checkbox',
          ...
          admin: { width: '25%', description: 'Gule/amber prikker.' },
        },
        {
          name: 'showJobs',
          type: 'checkbox',
          ...
          admin: { width: '25%', description: 'Lyseblå prikker.' },
        },
        {
          name: 'showOppdrag',
          type: 'checkbox',
          defaultValue: true,
          label: 'Vis oppdrag',
          admin: { width: '25%', description: 'Grønne prikker.' },
        },
      ],
    },
    breddeField,
